...
The entirety of the adtech industry that grew around it now resists transparency because its revenue depends on the fog. For example, attested attribution has been commodity technology for years. Any exchange could have proven that its auctions were honest. None did.
